        ...
        <section id="hero" className="hero">
          <div className="container hero-content">
            ...
            <ul className="hero-features">
              <li><Icon name="check-circle" className="icon" /> Qualité IPTV 4K/UHD</li>
              <li><Icon name="check-circle" className="icon" /> IPTV France &amp; International</li>
              <li><Icon name="check-circle" className="icon" /> Garantie Satisfait ou Remboursé</li>
            </ul>
        ...
        <section id="pricing" className="pricing-section">
          <div className="container">
            ...
            <div id="standard-plans" className="pricing-container active">
              {[
                ["1 Mois", "€15.23", "/Mois"],
                ["3 Mois", "€26.34", "/3 Mois", true, "Meilleure Valeur"],
                ["6 Mois", "€36.78", "/6 Mois"],
                ["12 Mois", "€48.98", "/An"],
                ...
                <div key={name as string} className={`pricing-card ${popular ? "popular" : ""}`}>
                  ...
                  <ul className="pricing-features">
                    <li><Icon name="check" className="icon" /> <strong>20K+ Chaînes HD</strong></li>
                    <li><Icon name="check" className="icon" /> <strong>120K+ Films &amp; Séries</strong></li>
                    <li><Icon name="check" className="icon" /> <strong>Performance Fiable</strong></li>
                    <li><Icon name="check" className="icon" /> <strong>Tous les appareils supportés</strong></li>
                    <li><Icon name="check" className="icon" /> <strong>Support Chat 24/7</strong></li>
                    <li><Icon name="check" className="icon" /> <strong>Contenu Adulte (Optionnel)</strong></li>
                  </ul>
            ...
            <div id="premium-plans" className="pricing-container">
              {[
                ["1 Mois Premium", "€25.32", "/Mois"],
                ["3 Mois Premium", "€37.13", "/3 Mois", true, "Top Choix"],
                ["6 Mois Premium", "€45.09", "/6 Mois"],
                ["12 Mois Premium", "€68.24", "/An"],
              ].map(([name, price, suffix, popular, badge]) => (
                <div key={name as string} className={`pricing-card ${popular ? "popular" : ""}`}>
                  {badge && <div className="popular-badge">{badge}</div>}
                  <h3 className="plan-name">{name}</h3>
                  <div className="plan-price">{price}<span>{suffix}</span></div>
                  <ul className="pricing-features">
                    <li><Icon name="check" className="icon" /> <strong>Serveur Premium Anti-Coupure</strong></li>
                    <li><Icon name="check" className="icon" /> <strong>47K+ Chaînes 4K/UHD</strong></li>
                    <li><Icon name="check" className="icon" /> <strong>180K+ Films &amp; Séries</strong></li>
                    <li><Icon name="check" className="icon" /> <strong>Priorité événements sportifs</strong></li>
                    <li><Icon name="check" className="icon" /> <strong>Couverture Globale (US/UK/EU)</strong></li>
                    <li><Icon name="check" className="icon" /> <strong>Contenu Adulte (Optionnel)</strong></li>
                  </ul>
                  <a href="#" className={popular ? "btn btn-primary" : "btn btn-outline"}>Commander</a>
                  <Image
        ...
        <section id="devices" className="devices-section">
          ...
          <div className="container">
            ...
            <div className="devices-grid">
              ...
              <div className="device-card"><Icon name="android" className="icon" /><h3>Appareils Android</h3></div>
          ...
          <div className="container">
            ...
            <div className="faq-grid">
              <details className="faq-item">
                <summary className="faq-question">De quoi ai-je besoin pour l&apos;IPTV ? <Icon name="chevron-down" className="icon" /></summary>
              ...
              <details className="faq-item">
                <summary className="faq-question">Ai-je besoin d&apos;un VPN pour l&apos;IPTV ? <Icon name="chevron-down" className="icon" /></summary>
                <div className="faq-answer">
              ...
              <details className="faq-item">
                <summary className="faq-question">Puis-je regarder l&apos;IPTV sur mon téléphone ? <Icon name="chevron-down" className="icon" /></summary>
                <div className="faq-answer">
              ...
              <details className="faq-item">
                <summary className="faq-question">Faut-il une bonne connexion WiFi ? <Icon name="chevron-down" className="icon" /></summary>
                <div className="faq-answer">
                  <p>Une connexion d&apos;au moins 10 Mbps est recommandée pour la HD, et 16-25 Mbps pour le streaming en Ultra HD 4K stable.</p>
                </div>
              </details>
              <details className="faq-item">
                <summary className="faq-question">L&apos;IPTV fonctionne-t-elle sur une vieille TV ? <Icon name="chevron-down" className="icon" /></summary>
                <div className="faq-answer">
