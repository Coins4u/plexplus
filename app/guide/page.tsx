    ...
    <>
      ...
      <main className="guide-section">
        <div className="container">
          ...
          >
            Get up and running in minutes. Follow our premium step-by-step tutorials to set up Plex Plus on any device.
          </p>
            ...
            <div className="steps-container">
              ...
              <div className="step-item">
                ...
                <div className="step-content">
                  ...
                  <p>
                    ...
                    <strong>&quot;Install unknown apps&quot;</strong> and set it to <strong>ON</strong> for the
                    Downloader app.
                  </p>
              ...
              <div className="step-item">
                ...
                <div className="step-content">
                  ...
                  <p>
                    Launch Downloader and type the following URL:{" "}
                    <b>https://www.iptvsmarters.com/smarters.apk</b>. Click <strong>Go</strong> and then click{" "}
            ...
            <div className="steps-container">
              ...
              <div className="step-item">
                ...
                <div className="step-content">
                  <h4>Login</h4>
                  <p>
                    Enter the credentials provided after your purchase to enjoy live TV in 4K.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="steps-container">
              ...
              <div className="step-item">
                ...
                <div className="step-content">
                  <h4>Installation</h4>
                  <p>
                    Run the installer and launch the app from your desktop. Select{" "}
            ...
            <div className="steps-container">
              ...
              <div className="step-item">
                ...
                <div className="step-content">
                  ...
                  <p>
                    Enter <b>&quot;Plex Plus&quot;</b> as the Portal Name and paste the{" "}
                    <b>Portal URL</b> provided in your email.
                  </p>
                  <img
                    src="/guide/img/MAG Device5.jpg"
                    alt="Portal Settings"
                    className="step-img"
                  />
                </div>
